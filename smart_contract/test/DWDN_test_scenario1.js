...
contract('DWDN_test_scenario1', function(accounts){
  var instance_1;
  ...
  it("Donation with one user in the network (account[0]) - exception",function() {
    return DWDN.deployed().then(function(instance) {
      instance_1 = instance;
  ...
  it("Donation with 4 users in the network (account[0] - 1 ETH) - iterate",function() {
    return DWDN.deployed().then(function(instance) {
      instance_1 = instance;
  ...
  it("Donation with 4 users in the network (account[0] - 0.1 ETH) - iterate",function() {
    return DWDN.deployed().then(function(instance) {
      instance_1 = instance;
  ...
  it("Donation with 4 users in the network (account[0] - 0.01 ETH) - iterate",function() {
    return DWDN.deployed().then(function(instance) {
      instance_1 = instance;
  ...
  it("Donation with 4 users in the network (account[0] - 0.005 ETH) - iterate",function() {
    return DWDN.deployed().then(function(instance) {
      instance_1 = instance;
      ...
      assert.equal(balance3_afterCall - balance3 > web3.utils.fromWei(data[1],"ether") - margin, true, "Balance 3 Ok >");
      assert.equal(balance3_afterCall - balance3 < Number(web3.utils.fromWei(data[1],"ether")) + Number(margin), true, "Balance 3 Ok <");
      assert.equal(balance4_afterCall - balance4 > 0.001 - margin, true, "Balance 4 Ok >");
      assert.equal(balance4_afterCall - balance4 < 0.001 + Number(margin), true, "Balance 4 Ok <");
      assert.equal(balance5_afterCall,  balance5, "Balance 5 Ok");
  ...
  it("Donation with 4 users in the network (account[0] - 0.001 ETH) - iterate",function() {
    return DWDN.deployed().then(function(instance) {
      instance_1 = instance;
      ...
      assert.equal(balance2_afterCall - balance2 > 0.001 - margin, true, "Balance 2 Ok >");
      assert.equal(balance2_afterCall - balance2 < 0.001 + Number(margin), true, "Balance 2 Ok <");
      assert.equal(balance3_afterCall,  balance3, "Balance 3 Ok");
      assert.equal(balance4_afterCall,  balance4, "Balance 4 Ok");
      assert.equal(balance5_afterCall,  balance5, "Balance 5 Ok");
  ...
  it("Donation with 4 users in the network (account[0] - 0.0001 ETH) - iterate",function() {
    return DWDN.deployed().then(function(instance) {
      instance_1 = instance;
      ...
      assert.equal(balance2_afterCall,  balance2, "Balance 2 Ok");
      assert.equal(balance3_afterCall,  balance3, "Balance 3 Ok");
      assert.equal(balance4_afterCall,  balance4, "Balance 4 Ok");
      assert.equal(balance5_afterCall,  balance5, "Balance 5 Ok");
