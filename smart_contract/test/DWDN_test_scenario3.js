...
contract('DWDN_test_scenario3', function(accounts){
  var instance_1;
  ...
  it("Add another account to the network connected to account[1] - iterate", function() {
    return DWDN.deployed().then(function(instance) {
      instance_1 = instance;
      return instance_1.requestUserToJoinTheNetwork(mainAccount_1,{from:mainAccount_2});
    }).then(function() {
      return instance_1.getVariables(mainAccount_1,{from:mainAccount_1});
    }).then(function(data) {
      assert.equal(data[0],1,"_connectedUsersByAddress mainAccount_1 = 1");
      assert.equal(data[1],5,"_sizeOfConnectedUsersByAddress mainAccount_1 = 5");
      return instance_1.getVariables(mainAccount_1,{from:mainAccount_2});
    }).then(function(data) {
      assert.equal(data[0],1,"_connectedUsersByAddress mainAccount_2 = 1");
