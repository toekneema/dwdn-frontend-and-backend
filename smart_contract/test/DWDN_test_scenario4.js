...
contract('DWDN_test_scenario4', function(accounts){
  var instance_1;
  ...
  it("Owner change changeMaxMemory - iterate", function() {
    return DWDN.deployed().then(function(instance) {
      instance_1 = instance;
      return instance_1.changeMaxMemory(2,{from:mainAccount_1});
    }).then(function(){
      return instance_1.getParameters();
    }).then(function(data) {
      assert.equal(data[3],2,"_maxMemoryArray = 2");
    });
  });
  ...
  it("Owner change changeMaxMemory - iterate", function() {
    return DWDN.deployed().then(function(instance) {
      instance_1 = instance;
      return instance_1.changeMaxMemory(100,{from:mainAccount_1});
    }).then(function(){
      return instance_1.getParameters();
    }).then(function(data) {
